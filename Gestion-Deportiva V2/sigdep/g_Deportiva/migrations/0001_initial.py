# Generated by Django 4.2.1 on 2023-08-03 22:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo_user', models.ImageField(blank=True, upload_to='media/')),
                ...
                ('file_documentidentity', models.FileField(blank=True, upload_to='documents/')),
                ('file_v', models.FileField(blank=True, upload_to='documents/')),
                ('file_f', models.FileField(blank=True, upload_to='documents/')),
                ('modified_at', models.DateTimeField(auto_now_add=True)),
                ('is_instructors', models.BooleanField()),
                ('allergies', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='g_Deportiva.allergies')),
                ('disabilities', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='g_Deportiva.disabilities')),
            ],
        ),
        migrations.CreateModel(
            name='Rol',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('team_image', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('people', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='g_Deportiva.people')),
                ('rol', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='g_Deportiva.rol')),
            ],
            options={
                'db_table': 'user',
            },
