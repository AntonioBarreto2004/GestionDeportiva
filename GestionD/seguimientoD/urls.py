...
urlpatterns = [
    ...
    path('dalete-team/<int:pk>/', viewsTeam.delete_team, name='Delete Team'),
    ...
    path('create-anthrop/', viewsAnthropometric.list_anthro, name='Create Anthropometric'),
    path('update-anthrop/<int:pk>/', viewsAnthropometric.list_anthro, name='Update Anthropometric'),
    path('dalete-anthrop/<int:pk>/', viewsAnthropometric.list_anthro, name='Delete Anthropometric'),
]